        ...
        <section className="py-16 relative">
          <div className="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto  text-black">
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:items-start">
              <div className="basis-8/12 border border-lime-700 m-3 p-3 rounded-xl">
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <Button
                                ...
                                className="mt-2 text-white  bg-lime-700"
                              >
                        ...
                        <div className="col-span-2 text-center">
                          <div className="flex items-center gap-2 mt-2">
                            <button
                              onClick={() =>
                                dispatch(
                                  decreaseCart({ ...cartItem, userId: user.id })
                                )
                              }
              ...
              <div className="basis-4/12">
                <div className="border border-gray-200 bg-white shadow-sm rounded-xl py-8 px-6">
                  <h3 className="font-manrope font-bold text-2xl leading-7 mb-6 ">
                    Summary
                  </h3>
                  ...
                  <button
                    ...
                    className="inline-block w-full bg-lime-700 font-semibold text-center text-white py-3 px-4 rounded-md mt-6 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime-700"
                  >
                    Clear Cart
                  </button>
                  <Link to="/ordersummary">
                    <button className="inline-block w-full font-semibold bg-lime-900 text-center text-white py-3 px-4 rounded-md mt-6 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime-900">
