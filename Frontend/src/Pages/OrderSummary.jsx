          ...
          <div className="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <form>
              <div className="">
                ...
                <div className="relative">
                  <input
                    ...
                    id=""
                    name="text"
                    className="w-full rounded-md border border-gray-200 px-4  pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                    onChange={(e) =>
                      setpayHereFormData({
                        ...payHereFormData,
                  ...
                  <div className="relative flex-shrink-0 sm:w-7/12">
                    ...
                    <div className="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                      <img
                        ...
                        src="https://flagpack.xyz/_nuxt/b570febe9d96977515795be73e7bb057.svg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <button
                ...
                className="rounded-full w-full  py-3 px-6 text-center justify-center items-center bg-indigo-600 font-semibold text-lg text-white flex transition-all duration-500 hover:bg-indigo-700"
              >
                Place Order
              </button>
              {publishError && (
